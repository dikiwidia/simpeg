  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-users"></i> Karyawan<span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="<?php echo $url; ?>karyawan/angkat">Angkat Karyawan</a></li>
          <li><a href="<?php echo $url; ?>karyawan/jabstruk">Jabatan Struktural</a></li>
          <li><a href="<?php echo $url; ?>karyawan/tugas">Daftar Penugasan</a></li>
          <li><a href="<?php echo $url; ?>karyawan/cuti">Daftar Cuti</a></li>
          <li><a href="<?php echo $url; ?>karyawan/golgaji">Daftar Gaji</a></li>
        </ul>
      </li>
      <?php } if($ses['level_user'] > 1){ ?>
